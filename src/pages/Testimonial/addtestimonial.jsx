...
export default function Addtestimonial() {
  ...
  let AddTestimonial = (e) => {
    ...
    axios.post(`${apibaseurl}testimonial/create`, data)
      .then((res) => res.data)
      .then((finalres) => {
            ...
            <div className='grid grid-cols-3'>
              <div className='col-span-2'>
                ...
                <div className='flex flex-col mx-2 my-4 gap-2 text-[18px ] font-bold'>
                  ...
                  <input name='_TestimonialComponiName' type="text" placeholder='Enter  Company Name ' className='w-xl px-2 py-2 border border-violet-300 bg-white outline-none rounded' />
                </div>

                <div className='flex flex-col mx-2 my-4 gap-2 text-[18px ] font-bold'>
                  <label htmlFor="Name" > Rating </label>
                  <input name='_TestimonialRating' type="number" placeholder='Enter rating ' className='w-xl px-2 py-2 border border-violet-300 bg-white outline-none rounded' />
                </div>

                <div className='flex flex-col mx-2 my-4 gap-2 text-[18px ] font-bold'>
                  <label htmlFor="Name" > Order </label>
                  <input name='_TestimonialOrder' type="number" placeholder='Enter order ' className='w-xl px-2 py-2 border border-violet-300 bg-white outline-none rounded' />
                </div>
                <div className='flex flex-col mx-2 my-4 gap-2 text-[18px ] font-bold'>
                  <label htmlFor="Name" > Discrition </label>
                  <textarea name='_TestimonialAbout' type="text" className='w-[575px]  px-2 py-2 border border-violet-300 bg-white outline-none rounded' ></textarea>
                </div>
