          ...
          <div className='grid grid-cols-3'>
            <div className='col-span-2'>
                ...
                <div className='flex flex-col mx-2 my-4 gap-2 text-[18px ] font-bold'>
                  ...
                  <select required name="_PerentCategory" type="text" placeholder='Enter Catagory Name ' className='w-xl px-2 py-2 text-neutral-950 border border-violet-300 bg-white outline-none rounded  text-neutral-500' >
